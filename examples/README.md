...
upload it to your GRID account and replace `REPLACE_WITH_YOUR_SPREADSHEET_ID` with its workbook id. See our [quick start guide](https://sdk.grid.is/api-reference/getting-started) for more details.
...
See our [quick start guide](https://sdk.grid.is/api-reference/getting-started) for more details.
